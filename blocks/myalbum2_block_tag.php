 ...
 * @return array
 */
function myalbum2_tag_block_cloud_show($options): array
{
 ...
 * @return string
 */
function myalbum2_tag_block_cloud_edit($options): string
{
    require_once XOOPS_ROOT_PATH . '/modules/tag/blocks/block.php';
 ...
 * @return array
 */
function myalbum2_tag_block_top_show($options): array
{
    if (file_exists(XOOPS_ROOT_PATH . '/modules/tag/blocks/block.php')) {
        //        global $module_dirname;
        $module_dirname = '';
